# BladeRF Radar Project
This project is designed to gain an understanding of radars and how they work and what the limitations might be for an SDR based radar.

## Dependencies

The code in this project has the following dependecies:

1. [CMake 3.12+](https://cmake.org/download/ )
...
mkdir build
cd build
cmake -G "Visual Studio 17 2022 Win64" -T host=x64 ..
